...
//连接AeccCustomDraw.lib库文件
#pragma comment (lib ,"AeccCustomDraw.lib")

//导入AutoCAD 和 Civil 3D ActiveX 接口库

#import "acax17enu.tlb" raw_interfaces_only no_namespace

// Aec Base
#import "C:\Program Files\AutoCAD Civil 3D 2008\AecXBase.tlb" raw_interfaces_only no_namespace
#import "C:\Program Files\AutoCAD Civil 3D 2008\AecXUiBase.tlb" raw_interfaces_only no_namespace
// Aec Civil
#import "C:\Program Files\AutoCAD Civil 3D 2008\Civil\AeccXLand.tlb"  raw_interfaces_only no_namespace exclude("tagDOMNodeType", "IXMLDOMImplementation", "IXMLDOMParseError", "IXMLDOMNode", "IXMLDOMNodeList", "IXMLDOMNamedNodeMap", "IXMLDOMDocumentType", "IXMLDOMDocumentFragment", "IXMLDOMCharacterData", "IXMLDOMText", "IXMLDOMComment", "IXMLDOMCDATASection", "IXMLDOMProcessingInstruction", "IXMLDOMAttribute", "IXMLDOMElement", "IXMLDOMEntityReference", "IXMLDOMDocument")
#import "C:\Program Files\AutoCAD Civil 3D 2008\Civil\AeccXUiLand.tlb" raw_interfaces_only no_namespace exclude("UINT_PTR")
