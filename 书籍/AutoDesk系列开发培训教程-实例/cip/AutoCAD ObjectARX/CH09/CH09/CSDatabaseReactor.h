...
//-----------------------------------------------------------------------------
//----- CSDatabaseReactor.h : Declaration of the CSDatabaseReactor
//-----------------------------------------------------------------------------
#pragma once
...
//----- your class to other ARX/DBX modules
	...
	//
	//----------------------------------------------------------------------------------------------
class /*DLLIMPEXP*/ CSDatabaseReactor : public AcDbDatabaseReactor {

public:
	ACRX_DECLARE_MEMBERS(CSDatabaseReactor) ;
...
public:
	CSDatabaseReactor (AcDbDatabase *pDb =NULL) ;
...
#ifdef CH09_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CSDatabaseReactor)
#endif
