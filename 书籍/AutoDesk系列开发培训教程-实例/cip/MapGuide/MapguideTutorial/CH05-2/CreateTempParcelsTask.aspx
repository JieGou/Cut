...
<body class="AppFrame">   
    ...
    <div class="bold">通过交互绘制地块。</div><br />
    <input type="button" value="绘制地块" onclick="javascript:DigitizePolygon();" id="Button1" /><br /><br />
    
    <h1 class="AppHeading">第三步:</h1>
    <div class="bold">填写属性信息</div>
    
    <form id="form1" action="CreateTempParcels.aspx" method="post">
        <strong>面积:</strong><br />
        ...
        <!--
        <textarea id="res" rows="10" cols="32" visible="false"></textarea>
        -->
        <input type="hidden" id="coordinates" name="coordinates" />
        <input type="submit" value="创建新地块"/>
