...
<%
    ...
    try
    {
        ...
        //指定输出文件及其路径
        String MapResContFilePath = realPath + @"Support\RepositoryContent .xml";
        // 初始化网络层
        ...
        ///获取仓储内容   
        MgByteReader byteReader = resService.GetRepositoryContent(resourceID);
        //保存为XML文件
        MgByteSink byteSink = new MgByteSink(byteReader);
        byteSink.ToFile(MapResContFilePath);
        Response.Write("<b> 仓储内容文件  " + MapResContFilePath + " 创建完毕.");
    }
