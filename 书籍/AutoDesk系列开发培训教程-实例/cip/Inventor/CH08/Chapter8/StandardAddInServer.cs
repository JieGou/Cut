...
namespace Chapter8
{
    ...
    /// </summary>
    [GuidAttribute("69ac283d-c005-4333-b4f9-bdadb6fde2cd")]
    public class StandardAddInServer : Inventor.ApplicationAddInServer
    {
        ...
        public void SelectionSample()
        {
            frmSelection myForm = new frmSelection(m_inventorApplication);
            myForm.Show();
        }
